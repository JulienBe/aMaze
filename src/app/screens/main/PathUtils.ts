...
export function findShortestPath(cellGroups: MazeCell[][], entryCell: MazeCell, exitCell: MazeCell): MazeCell[] {
    ...
    const prev = Array.from({ length: height }, () => Array(width).fill(null as [number, number] | null));
